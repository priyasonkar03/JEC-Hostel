      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap3" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="createRoom.php">Create Rooms</a>
            <a class="collapse-item" href="assignRoom.php">Assign Rooms</a>
            <a class="collapse-item" href="studentsWithRooms.php">Student Rooms</a>
            <a class="collapse-item" href="manageRooms.php">Manage Rooms</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrapcon" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <!-- <a class="collapse-item" href="attendance-history.php">Attendance History</a> -->
            <a class="collapse-item" href="takeAttendance.php">Take Attendance</a>
            <a class="collapse-item" href="viewAttendance.php">View Hostel Attendance</a>
