...
(1, 'Thomas', 'Omari','AMS005', '12345', '1', '2', '2022-10-31'),
(3, 'Samuel', 'Ondieki', 'AMS007', '12345', '1', '2', '2022-10-31'),
(4, 'Milagros', 'Oloo',  'AMS011', '12345', '1', '2', '2022-10-31'),
(5, 'Luis', 'Ayo',  'AMS012', '12345', '1', '4', '2022-10-31'),
(6, 'Sandra', 'Sagero',  'AMS015', '12345', '1', '4', '2022-10-31'),
(7, 'Smith', 'Makori', 'AMS017', '12345', '1', '4', '2022-10-31'),
(8, 'Juliana', 'Kerubo',  'AMS019', '12345', '3', '5', '2022-10-31'),
(9, 'Richard', 'Semo',  'AMS021', '12345', '3', '5', '2022-10-31'),
(10, 'Jon', 'Mbeeka',  'AMS110', '12345', '4', '6', '2022-10-07'),
(11, 'Aida', 'Moraa',  'AMS133', '12345', '4', '6', '2022-10-07'),
(12, 'Miguel', 'Bush',  'AMS135', '12345', '4', '6', '2022-10-07'),
(13, 'Sergio', 'Hammons',  'AMS144', '12345', '4', '6', '2022-10-07'),
(14, 'Lyn', 'Rogers',  'AMS148', '12345', '4', '6', '2022-10-07'),
(15, 'James', 'Dominick',  'AMS151', '12345', '4', '6', '2022-10-07'),
(16, 'Ethel', 'Quin',  'AMS159', '12345', '4', '6', '2022-10-07'),
(17, 'Roland', 'Estrada',  'AMS161', '12345', '4', '6', '2022-10-07');
...
/*! No change any code this table (single table use for only registration process)*/
CREATE TABLE `tblregstudents` (
    ...
    `degree` VARCHAR(100),
    `branch` VARCHAR(100),
    `jeePercentage` DECIMAL(5,2),
    `hostelType` ENUM('Boy', 'Girl'),     
    `regDate` TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);


INSERT INTO `tblregstudents` (`firstName`, `lastName`, `gender`, `dob`, `email`, `phone`, `address`, `password`, `category`, `session`, `degree`, `branch`, `jeePercentage`, `hostelType`)
VALUES 
...
ALTER TABLE tblstudents
ADD roomId INT,
ADD CONSTRAINT fk_room FOREIGN KEY (roomId) REFERENCES tblrooms(Id);

-- Attendace by Student
CREATE TABLE tblattendancebystd (
  Id INT PRIMARY KEY AUTO_INCREMENT,
  studentId INT NOT NULL,
  status ENUM('In', 'Out') NOT NULL,
  timeRecorded DATETIME NOT NULL,
  remarks VARCHAR(255),
  FOREIGN KEY (studentId) REFERENCES tblregstudents(Id)
);
